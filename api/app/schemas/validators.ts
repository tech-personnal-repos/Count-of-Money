...
export const isDate = '^([0-2]\\d{3}-((0\\d)|(1[0-2]))-((0\\d)|([0-2]\\d)|(3[0-1])))$';
export const isDateRange = '^\\d{3}-\\d{3}';
export const isDateTZ = '^(d{4}-[01]d-[0-3]dT[0-2]d:[0-5]d:[0-5]d.d+)Z?$';
export const isDayName = '^(Sunday)|(Monday)|(Tuesday)|(Wednesday)|(Thursday)|(Friday)|(Saturday)$';
...
export const isName = '^[a-zA-ZŠŒŽšœžŸâêôûÄéÆÇàèÊùÌÍÎÏîÒÓÔÕÖØÙÚÛÜÝàáâãäåæçèéêëìíîïðñòóôõöùúûüýÿ\\- ]+$';
